  ...
  const pages = [
    {
      ...
      rating: 4.8,
      description: 'Description for business in this category',
    },
    {
      id: '2',
      ...
      rating: 4.6,
      description: 'Another business in this category',
    },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Businesses in {categoryName} category</p>
        </div>
